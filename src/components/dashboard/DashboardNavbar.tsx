  ...
  return (
    <header className="w-full h-14 sm:h-[72px] bg-white flex items-center justify-between px-4 sm:px-6 shrink-0 relative z-20 sticky top-0 border-b border-gray-100 sm:border-none shadow-sm sm:shadow-none">
      ...
      <div className="flex items-center justify-between w-full sm:hidden">
        ...
        <Link href="/dashboard/notifications" className="relative p-1 -mr-1 text-gray-600">
      ...
      <div className="hidden sm:flex items-center justify-between w-full">
        ...
        <div className="flex items-center gap-5 shrink-0 ml-4">
          ...
          <div className="flex items-center gap-2">
            {/* Notifications */}
            <Link href="/dashboard/notifications" className="w-9 h-9 flex items-center justify-center text-gray-500 hover:bg-gray-50 hover:text-gray-700 rounded-full transition-colors relative">
              <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M15 17h5l-1.405-1.405A2.032 2.032 0 0118 14.158V11a6.002 6.002 0 00-4-5.659V5a2 2 0 10-4 0v.341C7.67 6.165 6 8.388 6 11v3.159c0 .538-.214 1.055-.595 1.436L4 17h5m6 0v1a3 3 0 11-6 0v-1m6 0H9"></path></svg>
              <div className="absolute top-1.5 right-1.5 w-3 h-3 bg-blue-600 text-white text-[8px] font-bold flex items-center justify-center rounded-full border border-white">3</div>
            </Link>
            
            {/* Messages */}
            <Link href="/dashboard/messages" className="w-9 h-9 flex items-center justify-center text-gray-500 hover:bg-gray-50 hover:text-gray-700 rounded-full transition-colors relative">
            ...
            {/* Chat */}
            <Link href="/dashboard/chat" className="w-9 h-9 flex items-center justify-center text-gray-500 hover:bg-gray-50 hover:text-gray-700 rounded-full transition-colors relative">
              ...
              <>
                ...
                <div className="absolute right-0 mt-2 w-56 bg-white rounded-xl shadow-lg border border-gray-100 py-2 z-50 animate-in fade-in slide-in-from-top-2">
                  ...
                  <div className="py-1 flex flex-col gap-1">
                    <Link href="/dashboard/profile" onClick={() => setIsProfileOpen(false)} className="flex items-center gap-3 px-4 py-2 text-sm text-gray-600 hover:bg-gray-50 hover:text-[#0052CC] transition-colors">
